import { DeleteTenantAdministratorDocument, TenantAdministratorDocument, TenantAdministratorFragment, UpdateTenantAdministratorDocument } from '@/graphql/Memberships';
