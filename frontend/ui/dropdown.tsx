...
export const DropdownMenuTrigger = Object.assign(DropdownMenuPrimitive.Trigger, {
  CornerDots({
    className,
    ...props
...
export const DropdownMenuContent = Object.assign(DropdownMenuContentWrapper, {
  Actions({
    actions,
    ...props
  }: { actions: React.ReactNode[] } & DropdownMenuContentProps) {
    return <DropdownMenuContentWrapper {...props}>{actions}</DropdownMenuContentWrapper>;
  },
});
