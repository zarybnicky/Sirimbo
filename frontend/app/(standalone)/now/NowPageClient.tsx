            ...
            {buckets.map((bucket) => (
              ...
              >
                  ...
                  <div className="flex flex-col gap-3">
                    {bucket.current.map(({ since, until, instance }) => (
                      ...
                      >
                        ...
                        {grouping === 'location' && (
                          <p className="mt-2 text-sm text-accent-9">
                            {`Trenéři: ${formatTrainers(instance) || '-'}`}
                          </p>
                        )}
                      </article>
                    ))}
                ...
                {bucket.upcoming.length > 0 && (
                  <div className="rounded-2xl border border-accent-6 bg-accent-1 p-4  flex flex-col gap-3">
