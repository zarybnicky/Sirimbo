...
useCohortsQuery.fetcher = (variables?: CohortsQueryVariables, options?: RequestInit['headers']) => fetcher<CohortsQuery, CohortsQueryVariables>(CohortsDocument, variables, options);
