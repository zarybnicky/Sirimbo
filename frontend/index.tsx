...
import { endpointUrl } from './lib/query';
...
export type DeleteUsersSkupinyByNodeIdInput = {
  /**
   * An arbitrary string value with no semantic meaning. Will be included in the
   * payload verbatim. May be used to track mutations by the client.
   */
...
export type DeleteUsersSkupinyPayload = {
   ...
   */
  clientMutationId: Maybe<Scalars['String']>;
  deletedUsersSkupinyNodeId: Maybe<Scalars['ID']>;
  /** Our root query field type. Allows us to run any query from our mutation payload. */
  query: Maybe<Query>;
...
export type Mutation = {
  ...
  deleteUsersSkupinyByNodeId: Maybe<DeleteUsersSkupinyPayload>;
  ...
  updateUsersSkupinyByNodeId: Maybe<UpdateUsersSkupinyPayload>;
...
/** The root mutation type which contains root level fields which mutate data. */
export type MutationDeleteUsersSkupinyByNodeIdArgs = {
...
/** The root mutation type which contains root level fields which mutate data. */
export type MutationUpdateUsersSkupinyByNodeIdArgs = {
...
export type Query = Node & {
  ...
  cohortMembers: Maybe<MembersConnection>;
  ...
  usersSkupinies: Maybe<UsersSkupiniesConnection>;
  usersSkupiny: Maybe<UsersSkupiny>;
  /** Reads a single `UsersSkupiny` using its globally unique `ID`. */
  usersSkupinyByNodeId: Maybe<UsersSkupiny>;
  video: Maybe<Video>;
...
/** The root query type which gives access points into the data universe. */
export type QueryUsersSkupiniesArgs = {
  after?: InputMaybe<Scalars['Cursor']>;
  before?: InputMaybe<Scalars['Cursor']>;
...
/** The root query type which gives access points into the data universe. */
export type QueryUsersSkupinyByNodeIdArgs = {
  nodeId: Scalars['ID'];
};
...
export type UpdateUsersSkupinyByNodeIdInput = {
  /**
   * An arbitrary string value with no semantic meaning. Will be included in the
   * payload verbatim. May be used to track mutations by the client.
   */
...
export type CohortsQuery = { __typename?: 'Query', skupinies: { __typename?: 'SkupiniesConnection', nodes: Array<{ __typename?: 'Skupiny', sId: string, sName: string, sLocation: string, sDescription: string, sVisible: boolean, sColorRgb: string }> } | null };
...
export type CohortMembersQuery = { __typename?: 'Query', cohortMembers: { __typename?: 'MembersConnection', nodes: Array<{ __typename?: 'Member', uJmeno: string | null, uPrijmeni: string | null, uRodneCislo: string | null, uTelefon: string | null, uEmail: string | null }> } | null };
...
useAnnouncementListQuery.fetcher = (variables: AnnouncementListQueryVariables) => fetcher<AnnouncementListQuery, AnnouncementListQueryVariables>(AnnouncementListDocument, variables);
...
useArticleQuery.fetcher = (variables: ArticleQueryVariables) => fetcher<ArticleQuery, ArticleQueryVariables>(ArticleDocument, variables);
...
useArticlesQuery.fetcher = (variables: ArticlesQueryVariables) => fetcher<ArticlesQuery, ArticlesQueryVariables>(ArticlesDocument, variables);
export const CohortsDocument = `
    query Cohorts {
  skupinies(condition: {sVisible: true}) {
    nodes {
      sId
      sName
      sLocation
...
export const useCohortsQuery = <
    ...
    >(
      ...
      options?: UseQueryOptions<CohortsQuery, TError, TData>
    ) =>
    useQuery<CohortsQuery, TError, TData>(
      variables === undefined ? ['Cohorts'] : ['Cohorts', variables],
      fetcher<CohortsQuery, CohortsQueryVariables>(CohortsDocument, variables),
      options
    );
useCohortsQuery.document = CohortsDocument;


useCohortsQuery.getKey = (variables?: CohortsQueryVariables) => variables === undefined ? ['Cohorts'] : ['Cohorts', variables];
;

useCohortsQuery.fetcher = (variables?: CohortsQueryVariables) => fetcher<CohortsQuery, CohortsQueryVariables>(CohortsDocument, variables);
export const CohortMembersDocument = `
    query CohortMembers($id: Int!) {
  cohortMembers(id: $id) {
    nodes {
      uJmeno
      uPrijmeni
...
useCohortMembersQuery.fetcher = (variables: CohortMembersQueryVariables) => fetcher<CohortMembersQuery, CohortMembersQueryVariables>(CohortMembersDocument, variables);
...
useActiveProspectsQuery.fetcher = (variables?: ActiveProspectsQueryVariables) => fetcher<ActiveProspectsQuery, ActiveProspectsQueryVariables>(ActiveProspectsDocument, variables);
...
useSubmitProspectFormMutation.fetcher = (variables: SubmitProspectFormMutationVariables) => fetcher<SubmitProspectFormMutation, SubmitProspectFormMutationVariables>(SubmitProspectFormDocument, variables);
...
useEventParticipantsQuery.fetcher = (variables: EventParticipantsQueryVariables) => fetcher<EventParticipantsQuery, EventParticipantsQueryVariables>(EventParticipantsDocument, variables);
...
useEventListQuery.fetcher = (variables: EventListQueryVariables) => fetcher<EventListQuery, EventListQueryVariables>(EventListDocument, variables);
...
useToggleEventVisibleMutation.fetcher = (variables: ToggleEventVisibleMutationVariables) => fetcher<ToggleEventVisibleMutation, ToggleEventVisibleMutationVariables>(ToggleEventVisibleDocument, variables);
...
useGalleryDirQuery.fetcher = (variables: GalleryDirQueryVariables) => fetcher<GalleryDirQuery, GalleryDirQueryVariables>(GalleryDirDocument, variables);
...
useGalleryDirListQuery.fetcher = (variables: GalleryDirListQueryVariables) => fetcher<GalleryDirListQuery, GalleryDirListQueryVariables>(GalleryDirListDocument, variables);
...
useToggleGalleryDirVisibleMutation.fetcher = (variables: ToggleGalleryDirVisibleMutationVariables) => fetcher<ToggleGalleryDirVisibleMutation, ToggleGalleryDirVisibleMutationVariables>(ToggleGalleryDirVisibleDocument, variables);
...
usePageQuery.fetcher = (variables: PageQueryVariables) => fetcher<PageQuery, PageQueryVariables>(PageDocument, variables);
...
usePageListQuery.fetcher = (variables?: PageListQueryVariables) => fetcher<PageListQuery, PageListQueryVariables>(PageListDocument, variables);
...
usePageRevisionsQuery.fetcher = (variables: PageRevisionsQueryVariables) => fetcher<PageRevisionsQuery, PageRevisionsQueryVariables>(PageRevisionsDocument, variables);
...
useCreatePageMutation.fetcher = (variables: CreatePageMutationVariables) => fetcher<CreatePageMutation, CreatePageMutationVariables>(CreatePageDocument, variables);
...
useUpdatePageMutation.fetcher = (variables: UpdatePageMutationVariables) => fetcher<UpdatePageMutation, UpdatePageMutationVariables>(UpdatePageDocument, variables);
...
useMenuQuery.fetcher = (variables?: MenuQueryVariables) => fetcher<MenuQuery, MenuQueryVariables>(MenuDocument, variables);
...
useReservationListQuery.fetcher = (variables: ReservationListQueryVariables) => fetcher<ReservationListQuery, ReservationListQueryVariables>(ReservationListDocument, variables);
...
useReservationRangeQuery.fetcher = (variables: ReservationRangeQueryVariables) => fetcher<ReservationRangeQuery, ReservationRangeQueryVariables>(ReservationRangeDocument, variables);
...
useToggleReservationVisibleMutation.fetcher = (variables: ToggleReservationVisibleMutationVariables) => fetcher<ToggleReservationVisibleMutation, ToggleReservationVisibleMutationVariables>(ToggleReservationVisibleDocument, variables);
...
useScheduleRangeQuery.fetcher = (variables: ScheduleRangeQueryVariables) => fetcher<ScheduleRangeQuery, ScheduleRangeQueryVariables>(ScheduleRangeDocument, variables);
...
useScheduleListQuery.fetcher = (variables: ScheduleListQueryVariables) => fetcher<ScheduleListQuery, ScheduleListQueryVariables>(ScheduleListDocument, variables);
...
useToggleScheduleVisibleMutation.fetcher = (variables: ToggleScheduleVisibleMutationVariables) => fetcher<ToggleScheduleVisibleMutation, ToggleScheduleVisibleMutationVariables>(ToggleScheduleVisibleDocument, variables);
...
useTitleVideosQuery.fetcher = (variables?: TitleVideosQueryVariables) => fetcher<TitleVideosQuery, TitleVideosQueryVariables>(TitleVideosDocument, variables);