...
import { TenantFragment, useCurrentTenantQuery, useUpdateTenantMutation } from 'lib/graphql/Tenant';
...
export const TenantForm: React.FC<{
  ...
  return (
    <form className="grid gap-2" onSubmit={handleSubmit(onSubmit.execute)}>
      ...
      <SlateEditorElement control={control} name="memberInfo" label="Informace pro členy" />
