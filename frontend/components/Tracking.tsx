...
export const Tracking = React.memo(function Tracking() {
  ...
  const facebookRef = React.useRef<{ init: typeof init; pageView: typeof pageView; } | null>(null);
  ...
  return <GoogleAnalytics gaMeasurementId="UA-44456908-1" trackPageViews={{ ignoreHashChange: true }} />;
});
