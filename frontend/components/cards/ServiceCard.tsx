...
export function ServiceCard(props: ServiceCardProps & { children: React.ReactNode | React.ReactChildren; }) {
  const content = (
    <div className={classNames(
      ...
      <div className="h-full relative">
        <div className="absolute block inset-0 overflow-hidden">
          <img className="w-full h-full object-cover object-[50%_30%] transform transition duration-300 group-hover:scale-110" src={props.image} alt={props.header} />
        </div>
      </div>
