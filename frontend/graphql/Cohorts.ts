...
export type CohortWithMembersQuery = { entity: { id: string, name: string, location: string, isVisible: boolean, isArchived: boolean, colorRgb: string, ordering: number, description: string, cohortGroupId: string | null, externalIds: Array<string | null> | null, cohortMembershipsList: Array<{ id: string, since: string, until: string | null, status: Types.RelationshipStatus, person: { id: string, birthDate: string | null, name: string, cstsId: number | null, wdsfId: number | null, nationality: string, cohortIds: Array<string | null> | null, prefixTitle: string, suffixTitle: string, instagramUsername: string | null, tiktokUsername: string | null, facebookUrl: string | null, websiteUrl: string | null, note: string, firstName: string, lastName: string, gender: Types.GenderType, email: string | null, phone: string | null, taxIdentificationNumber: string | null, externalIds: Array<string | null> | null, isMember: boolean | null, isTrainer: boolean | null, isAdmin: boolean | null, cstsProgressList: Array<{ competitorName: string | null, points: string | null, finals: number | null, category: { id: string, name: string, discipline: string, series: string, ageGroup: string, competitorType: Types.CompetitorType, class: string } | null }> | null, address: { city: string | null, region: string | null, street: string | null, district: string | null, postalCode: string | null, orientationNumber: string | null, conscriptionNumber: string | null } | null } | null, cohort: { id: string, name: string, colorRgb: string } | null }> } | null };
