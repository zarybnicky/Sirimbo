...
export type FormResponsesQuery = { formResponses: { totalCount: number, nodes: Array<{ id: string, data: any, type: string, url: string, createdAt: string }> } | null };
...
export type SubmitFormMutation = { submitForm: { clientMutationId: string | null } | null };
