...
export type FileListQuery = { __typename?: 'Query', dokumentiesList: Array<{ __typename?: 'Dokumenty', id: string, dName: string, dFilename: string, dKategorie: number, dTimestamp: string | null, user: { __typename?: 'User', id: string, uJmeno: string | null, uPrijmeni: string | null } | null }> | null };
