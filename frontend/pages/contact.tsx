...
export default function ContactPage() {
  return <>
    <Heading color={{ r: 216, g: 28, b: 58, a: 0.6 }} text="Kontakt" image="/images/mohelnice2021-title.jpg" />

    <div className="col-popout prose mt-8">
      <h2>Fakturační údaje:</h2>
      <p>
        Taneční klub Olymp Olomouc, z. s.<br />
        Jiráskova 381/25, 779 00, Olomouc - Hodolany<br />
        lČO: 68347286, oddíl L. vl. 4133, Krajský soud v Ostravě, pobočka v Olomouci.<br />
    ...
    <div className="col-popout gap-4 my-8 grid lg:grid-cols-2">
      <div className="prose">
        ...
        <p>
          Mgr. Miroslav Hýža<br />
          Předseda, šéftrenér<br />
          tel: 737 545 525<br />
        ...
        <h3>Platby členských příspěvků, noví zájemci - Olomouc, potvrzení o platbách</h3>
        <p>
          Mgr. Lucie Benýšková<br />
          Vedoucí členských agend<br />
        ...
        <p>
          Martin Matýsek<br />
          Vedoucí projektu OlympDance<br />
          tel: 774 090 200<br />
