...
export default function HomePage() {
  ...
  return <>
    ...
    <div className="col-feature mb-4">
      {services.map((x, i) => (
        <ServiceCard key={i} href={x.href} image={x.image} header={x.header}>{x.text}</ServiceCard>
      ))}
    </div>
    ...
    <div className="my-8">
      ...
      >
        <iframe frameBorder="0" allowFullScreen allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" width="100%" height="100%" src="https://www.youtube.com/embed/flkU9ZeM7_8?autoplay=1&amp;mute=0&amp;controls=1&amp;origin=https%3A%2F%2Ftkolymp.cz&amp;playsinline=1&amp;showinfo=0&amp;rel=0&amp;iv_load_policy=3&amp;modestbranding=1&amp;enablejsapi=1&amp;widgetid=23"></iframe>
      </YoutubeEmbed>
    </div>
    ...
    <div className="my-12">
      ...
      {articles.map((x, i) => (
        <ServiceCard key={i} href={x.href} image={x.imgThumb} header={x.header}>{x.preview}</ServiceCard>
      ))}
    </div>
  </>;
}
