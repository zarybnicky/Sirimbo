...
export default function ExtracurricularsPage() {
  return (
    <>
      ...
      <p>
        Projekt Taneční kroužky Olymp DANCE vznikl v roce 2019 za hlavním účelem přiblížit
        dětem možnost tanečních tréninků na jejich škole. Děti nemusí nikam dojíždět, ale
        lektor dojíždí za nimi.
      </p>
