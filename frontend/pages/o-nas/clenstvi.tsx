    ...
    <>
      ...
      <div className="col-feature my-16 grid gap-16 px-4 md:grid-cols-3">
        ...
        <div className="col-span-2 -order-1 md:order-1">
          <SlateEditor readOnly name="clenstvi" value={text} />
        </div>
      </div>
    ...
    children: [
      {
        ...
        children: [
          {
            text: 'Sportovní centrum mládeže - status klubů s nejlepší prací s mládeží v ČR (jediný v Olomouckém kraji)',
          },
        ],
      },
      {
        type: 'li',
        children: [
          { text: 'Pravidelné tréninky s pěti trenéry Národního reprezentačního týmu' },
        ],
      },
      { type: 'li', children: [{ text: 'Moderní tréninkový systém a metodika' }] },
      {
        type: 'li',
        children: [
          { text: 'Možnost vstupu na taneční sál 7x týdně pro samostatný trénink' },
        ],
      },
      {
        type: 'li',
        children: [{ text: 'Zvýhodněná cena tanečních soustředění pořádaných klubem' }],
      },
      ...
      {
        type: 'li',
        children: [{ text: 'Pravidelná spolupráce se zahraničními trenéry' }],
      },
      { type: 'li', children: [{ text: 'Spolupráce s mistry světa' }] },
      {
        type: 'li',
        children: [
          { text: 'Finanční podpora nejlepších tanečních párů z dotačních titulů' },
        ],
      },
