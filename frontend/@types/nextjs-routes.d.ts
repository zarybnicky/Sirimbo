...
declare module "nextjs-routes" {
  ...
  export type Route =
    ...
    | StaticRoute<"/bpm2">
    | StaticRoute<"/clanky">
    | DynamicRoute<"/clanky/[id]/[[...slug]]", { "id": string; "slug"?: string[] | undefined }>
    | StaticRoute<"/clenove">
    ...
    | DynamicRoute<"/treninkove-programy/[id]/[...slug]", { "id": string; "slug": string[] }>
