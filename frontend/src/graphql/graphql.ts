...
export type UserQueryQuery = { __typename?: 'Query', getCurrentUser?: { __typename?: 'User', uTimestamp?: any | null | undefined, uSystem: boolean, uTelefon: string, uTeacher: boolean, uStreet: string, uRodneCislo?: string | null | undefined, uSkupina: any, uPrijmeni: string, uPoznamky: string, uPostalCode: string, uPohlavi: string, uPass: string, uOrientationNumber: string, uNationality: string, uNarozeni: any, uMemberUntil?: any | null | undefined, uLogin: string, uMemberSince?: any | null | undefined, uLock: boolean, uLevel: number, uJmeno: string, uGroup: any, uId: any, uGdprSignedAt?: any | null | undefined, uEmail: string, uDancer: boolean, uDistrict: string, uCreatedAt: any, uConfirmed: boolean, uConscriptionNumber: string, uBan: boolean, uCity: string, permissionByUGroup?: { __typename?: 'Permission', peAkce: number, peAnkety: number, peAktuality: number, peDescription: string, peDokumenty: number, peGalerie: number, peId: any, peKonzole: number, peInzerce: number, peNabidka: number, peMain: number, peName: string, peNastenka: number, peNovinky: number, pePary: number, pePermissions: number, pePlatby: number, peRozpis: number, peSkupiny: number, peUsers: number } | null | undefined } | null | undefined };
...
export type SignOutMutation = { __typename?: 'Mutation', logout?: { __typename: 'LogoutPayload' } | null | undefined };
...
export type SignInMutation = { __typename?: 'Mutation', login?: { __typename?: 'LoginPayload', result?: { __typename?: 'LoginRecord', usr?: { __typename?: 'User', uTimestamp?: any | null | undefined, uSystem: boolean, uTelefon: string, uTeacher: boolean, uStreet: string, uRodneCislo?: string | null | undefined, uSkupina: any, uPrijmeni: string, uPoznamky: string, uPostalCode: string, uPohlavi: string, uPass: string, uOrientationNumber: string, uNationality: string, uNarozeni: any, uMemberUntil?: any | null | undefined, uLogin: string, uMemberSince?: any | null | undefined, uLock: boolean, uLevel: number, uJmeno: string, uGroup: any, uId: any, uGdprSignedAt?: any | null | undefined, uEmail: string, uDancer: boolean, uDistrict: string, uCreatedAt: any, uConfirmed: boolean, uConscriptionNumber: string, uBan: boolean, uCity: string, permissionByUGroup?: { __typename?: 'Permission', peAkce: number, peAnkety: number, peAktuality: number, peDescription: string, peDokumenty: number, peGalerie: number, peId: any, peKonzole: number, peInzerce: number, peNabidka: number, peMain: number, peName: string, peNastenka: number, peNovinky: number, pePary: number, pePermissions: number, pePlatby: number, peRozpis: number, peSkupiny: number, peUsers: number } | null | undefined } | null | undefined } | null | undefined } | null | undefined };
...
export const userQueryQueryMock: ExecutionResult<UserQueryQuery> = { data: { getCurrentUser: { permissionByUGroup: { peAkce: 84, peAnkety: -28, peAktuality: -96, peDescription: 'Hello World', peDokumenty: 23, peGalerie: 84, peId: 'BigInt', peKonzole: -16, peInzerce: 79, peNabidka: 29, peMain: 18, peName: 'Hello World', peNastenka: 94, peNovinky: 81, pePary: 76, pePermissions: -49, pePlatby: -70, peRozpis: 28, peSkupiny: 22, peUsers: 19 }, uTimestamp: 'Datetime', uSystem: false, uTelefon: 'Hello World', uTeacher: false, uStreet: 'Hello World', uRodneCislo: 'Hello World', uSkupina: 'BigInt', uPrijmeni: 'Hello World', uPoznamky: 'Hello World', uPostalCode: 'Hello World', uPohlavi: 'Hello World', uPass: 'Hello World', uOrientationNumber: 'Hello World', uNationality: 'Hello World', uNarozeni: 'Date', uMemberUntil: 'Datetime', uLogin: 'Hello World', uMemberSince: 'Datetime', uLock: false, uLevel: 3, uJmeno: 'Hello World', uGroup: 'BigInt', uId: 'BigInt', uGdprSignedAt: 'Datetime', uEmail: 'Hello World', uDancer: false, uDistrict: 'Hello World', uCreatedAt: 'Datetime', uConfirmed: true, uConscriptionNumber: 'Hello World', uBan: true, uCity: 'Hello World' } } };

export const upozorneniListQueryMock: ExecutionResult<UpozorneniListQuery> = { data: { allUpozornenis: { nodes: [{ upId: 'BigInt', upKdo: 'BigInt', upLock: false, upNadpis: 'Hello World', upText: 'Hello World', upTimestamp: 'Datetime', upTimestampAdd: 'Datetime', userByUpKdo: { uId: 'BigInt', uJmeno: 'Hello World', uPrijmeni: 'Hello World' }, upozorneniSkupiniesByUpsIdRodic: { nodes: [{ skupinyByUpsIdSkupina: { sName: 'Hello World', sDescription: 'Hello World', sColorText: 'Hello World', sColorRgb: 'Hello World' } }, { skupinyByUpsIdSkupina: { sName: 'Hello World', sDescription: 'Hello World', sColorText: 'Hello World', sColorRgb: 'Hello World' } }] } }, { upId: 'BigInt', upKdo: 'BigInt', upLock: false, upNadpis: 'Hello World', upText: 'Hello World', upTimestamp: 'Datetime', upTimestampAdd: 'Datetime', userByUpKdo: { uId: 'BigInt', uJmeno: 'Hello World', uPrijmeni: 'Hello World' }, upozorneniSkupiniesByUpsIdRodic: { nodes: [{ skupinyByUpsIdSkupina: { sName: 'Hello World', sDescription: 'Hello World', sColorText: 'Hello World', sColorRgb: 'Hello World' } }] } }], totalCount: -54 } } };

export const articlesAdminListQueryMock: ExecutionResult<ArticlesAdminListQuery> = { data: { allAktualities: { nodes: [{ atFoto: 'BigInt', atFotoMain: 'BigInt', atId: 'BigInt', atJmeno: 'Hello World', atKdo: 'BigInt', atPreview: 'Hello World', atText: 'Hello World', atTimestampAdd: 'Datetime', atTimestamp: 'Datetime' }], totalCount: 4 } } };

export const akceListQueryMock: ExecutionResult<AkceListQuery> = { data: { allAkces: { nodes: [{ aDo: 'Date', aId: 'BigInt', aInfo: 'Hello World', aDokumenty: 'Hello World', aJmeno: 'Hello World', aKapacita: 'BigInt', aKde: 'Hello World', aLock: true, aOd: 'Date', aTimestamp: 'Datetime', aVisible: false, akceItemsByAiIdRodic: { nodes: [{ aiId: 'BigInt', userByAiUser: { uJmeno: 'Hello World', uPrijmeni: 'Hello World', uId: 'BigInt' } }, { aiId: 'BigInt', userByAiUser: { uJmeno: 'Hello World', uPrijmeni: 'Hello World', uId: 'BigInt' } }], totalCount: -12 } }, { aDo: 'Date', aId: 'BigInt', aInfo: 'Hello World', aDokumenty: 'Hello World', aJmeno: 'Hello World', aKapacita: 'BigInt', aKde: 'Hello World', aLock: false, aOd: 'Date', aTimestamp: 'Datetime', aVisible: false, akceItemsByAiIdRodic: { nodes: [{ aiId: 'BigInt', userByAiUser: { uJmeno: 'Hello World', uPrijmeni: 'Hello World', uId: 'BigInt' } }], totalCount: 43 } }, { aDo: 'Date', aId: 'BigInt', aInfo: 'Hello World', aDokumenty: 'Hello World', aJmeno: 'Hello World', aKapacita: 'BigInt', aKde: 'Hello World', aLock: true, aOd: 'Date', aTimestamp: 'Datetime', aVisible: false, akceItemsByAiIdRodic: { nodes: [{ aiId: 'BigInt', userByAiUser: { uJmeno: 'Hello World', uPrijmeni: 'Hello World', uId: 'BigInt' } }, { aiId: 'BigInt', userByAiUser: { uJmeno: 'Hello World', uPrijmeni: 'Hello World', uId: 'BigInt' } }, { aiId: 'BigInt', userByAiUser: { uJmeno: 'Hello World', uPrijmeni: 'Hello World', uId: 'BigInt' } }], totalCount: 68 } }], totalCount: 33 } } };

export const setAkceVisibleMutationMock: ExecutionResult<SetAkceVisibleMutation> = { data: { updateAkceByAId: { akce: { aId: 'BigInt' } } } };

export const galleryDirListQueryMock: ExecutionResult<GalleryDirListQuery> = { data: { allGalerieDirs: { nodes: [{ gdHidden: false, gdId: 'BigInt', gdIdRodic: 'BigInt', gdLevel: 84, gdName: 'Hello World', gdPath: 'Hello World' }, { gdHidden: true, gdId: 'BigInt', gdIdRodic: 'BigInt', gdLevel: 29, gdName: 'Hello World', gdPath: 'Hello World' }], totalCount: -86 } } };
...
export const reservationAdminListQueryMock: ExecutionResult<ReservationAdminListQuery> = { data: { allNabidkas: { nodes: [{ nDo: 'Date', nId: 'BigInt', nLock: false, nMaxPocetHod: 'BigInt', nOd: 'Date', nPocetHod: 82, nTimestamp: 'Datetime', nTrener: 'BigInt', nVisible: false, nabidkaItemsByNiIdRodic: { nodes: [{ niPocetHod: 28, niPartner: 'BigInt', niLock: false, paryByNiPartner: { userByPIdPartner: { uJmeno: 'Hello World', uPrijmeni: 'Hello World', uId: 'BigInt' } } }, { niPocetHod: -90, niPartner: 'BigInt', niLock: true, paryByNiPartner: { userByPIdPartner: { uJmeno: 'Hello World', uPrijmeni: 'Hello World', uId: 'BigInt' } } }, { niPocetHod: 13, niPartner: 'BigInt', niLock: true, paryByNiPartner: { userByPIdPartner: { uJmeno: 'Hello World', uPrijmeni: 'Hello World', uId: 'BigInt' } } }] }, userByNTrener: { uJmeno: 'Hello World', uPrijmeni: 'Hello World', uId: 'BigInt' } }, { nDo: 'Date', nId: 'BigInt', nLock: false, nMaxPocetHod: 'BigInt', nOd: 'Date', nPocetHod: -2, nTimestamp: 'Datetime', nTrener: 'BigInt', nVisible: false, nabidkaItemsByNiIdRodic: { nodes: [{ niPocetHod: -40, niPartner: 'BigInt', niLock: false, paryByNiPartner: { userByPIdPartner: { uJmeno: 'Hello World', uPrijmeni: 'Hello World', uId: 'BigInt' } } }] }, userByNTrener: { uJmeno: 'Hello World', uPrijmeni: 'Hello World', uId: 'BigInt' } }], totalCount: -82 } } };
...
export const nabidkaListQueryMock: ExecutionResult<NabidkaListQuery> = { data: { allNabidkas: { nodes: [{ nDo: 'Date', nId: 'BigInt', nLock: true, nMaxPocetHod: 'BigInt', nOd: 'Date', nPocetHod: -90, nTimestamp: 'Datetime', nTrener: 'BigInt', nVisible: true, nabidkaItemsByNiIdRodic: { nodes: [{ niPocetHod: -14, niPartner: 'BigInt', niLock: false, paryByNiPartner: { userByPIdPartner: { uJmeno: 'Hello World', uPrijmeni: 'Hello World', uId: 'BigInt' } } }] }, userByNTrener: { uJmeno: 'Hello World', uPrijmeni: 'Hello World', uId: 'BigInt' } }, { nDo: 'Date', nId: 'BigInt', nLock: true, nMaxPocetHod: 'BigInt', nOd: 'Date', nPocetHod: -29, nTimestamp: 'Datetime', nTrener: 'BigInt', nVisible: true, nabidkaItemsByNiIdRodic: { nodes: [{ niPocetHod: 35, niPartner: 'BigInt', niLock: false, paryByNiPartner: { userByPIdPartner: { uJmeno: 'Hello World', uPrijmeni: 'Hello World', uId: 'BigInt' } } }, { niPocetHod: -34, niPartner: 'BigInt', niLock: false, paryByNiPartner: { userByPIdPartner: { uJmeno: 'Hello World', uPrijmeni: 'Hello World', uId: 'BigInt' } } }] }, userByNTrener: { uJmeno: 'Hello World', uPrijmeni: 'Hello World', uId: 'BigInt' } }], totalCount: 96 } } };

export const scheduleAdminListQueryMock: ExecutionResult<ScheduleAdminListQuery> = { data: { allRozpis: { nodes: [{ rDatum: 'Date', rId: 'BigInt', rKde: 'Hello World', rLock: true, rTimestamp: 'Datetime', rTrener: 'BigInt', rVisible: false, userByRTrener: { uId: 'BigInt', uJmeno: 'Hello World', uPrijmeni: 'Hello World' }, rozpisItemsByRiIdRodic: { nodes: [{ riDo: 'Time', riOd: 'Time', riId: 'BigInt', riPartner: 'BigInt' }] } }, { rDatum: 'Date', rId: 'BigInt', rKde: 'Hello World', rLock: false, rTimestamp: 'Datetime', rTrener: 'BigInt', rVisible: false, userByRTrener: { uId: 'BigInt', uJmeno: 'Hello World', uPrijmeni: 'Hello World' }, rozpisItemsByRiIdRodic: { nodes: [{ riDo: 'Time', riOd: 'Time', riId: 'BigInt', riPartner: 'BigInt' }, { riDo: 'Time', riOd: 'Time', riId: 'BigInt', riPartner: 'BigInt' }, { riDo: 'Time', riOd: 'Time', riId: 'BigInt', riPartner: 'BigInt' }] } }], totalCount: -82 } } };
...
export const signOutMutationMock: ExecutionResult<SignOutMutation> = { data: { logout: { __typename: 'LogoutPayload' } } };

export const signInMutationMock: ExecutionResult<SignInMutation> = { data: { login: { result: { usr: { permissionByUGroup: { peAkce: 40, peAnkety: 69, peAktuality: -18, peDescription: 'Hello World', peDokumenty: -58, peGalerie: -45, peId: 'BigInt', peKonzole: 56, peInzerce: 38, peNabidka: -65, peMain: -1, peName: 'Hello World', peNastenka: -57, peNovinky: 47, pePary: -10, pePermissions: 98, pePlatby: 13, peRozpis: 90, peSkupiny: -83, peUsers: 7 }, uTimestamp: 'Datetime', uSystem: true, uTelefon: 'Hello World', uTeacher: false, uStreet: 'Hello World', uRodneCislo: 'Hello World', uSkupina: 'BigInt', uPrijmeni: 'Hello World', uPoznamky: 'Hello World', uPostalCode: 'Hello World', uPohlavi: 'Hello World', uPass: 'Hello World', uOrientationNumber: 'Hello World', uNationality: 'Hello World', uNarozeni: 'Date', uMemberUntil: 'Datetime', uLogin: 'Hello World', uMemberSince: 'Datetime', uLock: false, uLevel: -100, uJmeno: 'Hello World', uGroup: 'BigInt', uId: 'BigInt', uGdprSignedAt: 'Datetime', uEmail: 'Hello World', uDancer: true, uDistrict: 'Hello World', uCreatedAt: 'Datetime', uConfirmed: false, uConscriptionNumber: 'Hello World', uBan: true, uCity: 'Hello World' } } } } };
