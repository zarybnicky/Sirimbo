...
filer_port="${SEAWEED_FILER_PORT:-5301}"
filer_grpc_port="${SEAWEED_FILER_GRPC_PORT:-5306}"
filer_http="${filer_host}:${filer_port}"
filer_shell="${filer_http}.${filer_grpc_port}"
master_host="${SEAWEED_MASTER_HOST:-127.0.0.1}"
master_port="${SEAWEED_MASTER_PORT:-5302}"
master_grpc_port="${SEAWEED_MASTER_GRPC_PORT:-5304}"
