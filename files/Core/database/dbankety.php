...
class DBAnkety extends Database
{
    ...
    public static function addAnketa($kdo, $jmeno, $text, $pristup, $visible) {
        list($kdo, $jmeno, $text, $pristup, $visible) =
            self::escape($kdo, $jmeno, $text, $pristup, $visible);

        $res = self::query('INSERT INTO ankety (ak_kdo,ak_jmeno,ak_text,ak_pristup,ak_visible) VALUES ' .
    ...
    public static function editAnketa($id, $jmeno, $text, $pristup, $visible) {
        list($id, $jmeno, $text, $pristup, $visible) =
            self::escape($id, $jmeno, $text, $pristup, $visible);

        $res = self::query("UPDATE ankety SET ak_jmeno='$jmeno',ak_text='$text',ak_pristup='$pristup'," .
