...
class DBPary extends Adapter
{
    ...
    public static function getLatestPartner($partner, $pohlavi)
    {
        ...
        $where = $pohlavi == 'm'
            ? 'p_id_partner="' . $partner . '"'
            : 'p_id_partnerka="' . $partner . '"';
    ...
    public static function newPartner($partner, $partnerka)
    {
        ...
        self::query(
            "INSERT INTO pary (p_id_partner, p_id_partnerka) VALUES ('$partner','$partnerka')"
        );
    }
    ...
    public static function noPartner($partner)
    {
        ...
        self::query(
            "INSERT INTO pary (p_id_partner, p_id_partnerka) VALUES ('$partner','0')"
        );
    ...
    public static function getPartnerRequestsForMe($id)
    {
        ...
        $res = self::query(
            ...
            FROM pary_navrh
                LEFT JOIN users ON pn_navrhl=u_id
    ...
    {
        list($navrhl, $partner, $partnerka) = self::escape($navrhl, $partner, $partnerka);
