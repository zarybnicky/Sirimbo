...
class DBPlatbyGroup extends Adapter
{
    ...
    {
        list($type, $name, $desc, $base) =
            self::escape($type, $name, $desc, $base);
    ...
    {
        list($id, $type, $name, $desc, $base) =
            self::escape($id, $type, $name, $desc, $base);
