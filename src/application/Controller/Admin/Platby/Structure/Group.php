...
class Group extends Structure
{
    ...
    public function remove($id = null)
    {
        ...
        if (((empty($_POST) || post('action') == 'confirm')
            ...
            $this->render(
                'src/application/View/Admin/Platby/StructureGroupRemove.inc',
                array(
                    'id' => $id,
                    'name' => $data['pg_name']
                )
    ...
    private function displayForm($action, $data = array())
    {
        ...
        foreach ($skupiny as &$array) {
            $new_data = array(
                ...
                . '</form>',
                'name' => getColorBox($array['s_color_rgb'], $array['s_description'])
                . '&nbsp;' . $array['s_name']
            );
            $array = $new_data;
        }unset($array);
        ...
        $this->render(
            'src/application/View/Admin/Platby/StructureGroupForm.inc',
            array(
                'id' => $id,
                'action' => $action,
                'category' => $data,
