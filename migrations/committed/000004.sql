...
$$ language sql stable;
grant execute on function akce_free_slots to anonymous;
...
$$ language sql stable;
grant execute on function akce_signed_up to anonymous;
...
$$ language sql stable;
grant execute on function akce_my_notes to anonymous;
