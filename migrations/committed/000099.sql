--! Previous: sha1:f24f4af377575b72add7fdf8b5082843b7deaee0
--! Hash: sha1:e95be68a289292b0a867c151549b5b7a2ca454c3

--! split: 1-current.sql
--! Included federated-full-rebuild.sql
...
--! EndIncluded federated-full-rebuild.sql
...
do $$
begin
  if to_regtype('public.competition_participation_record') is null then
    create type public.competition_participation_record as (
      person_id bigint,
      person_name text,
      federation text,
