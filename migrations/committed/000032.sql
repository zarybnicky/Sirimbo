--! Previous: sha1:6ba93ea08f57aee2d0571a96d3b24ae6d7e6bf99
--! Hash: sha1:be3ff845e7aa833447272d37e6eb53c4d08173b6
...
create or replace function person_recent_attendance(p person) returns setof event_attendance language sql as $$
  ...
  limit 20
$$ stable;
grant all on function person_recent_attendance to anonymous;
comment on function person_recent_attendance is '@simpleCollections only';
