--! Previous: sha1:5642da1a74ba3d65b625e2757dcb67ac418a757c
--! Hash: sha1:5878f729d46c72506f664b9537640d3c52793ce6
...
create unique index if not exists event_instance_registration_person_key
  on event_instance_registration (instance_id, person_id)
  where person_id is not null and legacy_registration_id is null;
