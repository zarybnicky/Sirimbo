--! Previous: sha1:1626b90d49f49d96087949cf2561b197bc2516ca
--! Hash: sha1:6f635485797f8fceea6b65eb1ccfac51ebe1dd32
...
alter table event drop column if exists location_id;
alter table event_instance drop column if exists location_id;
