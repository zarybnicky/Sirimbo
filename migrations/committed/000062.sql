--! Previous: sha1:f0ddf644d0ab3e8edb18bca94ebb7421eaf6f773
--! Hash: sha1:c13221efa223dfd1fa19945eb9b77962e24405f6
...
begin
  if not exists (
    ...
    where n.nspname = 'public'
      and t.typname = 'scoreboard_record'
  ) then
...
comment on type scoreboard_record is '@foreignKey (person_id) references person (id)
