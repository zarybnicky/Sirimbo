CREATE or replace FUNCTION public.reset_password(login character varying, email character varying) RETURNS void
...
-- OTP intent? reset pwd vs login magic link
-- allow just setting a password w/o the old pwd
